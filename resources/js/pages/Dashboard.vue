                ...
                <div v-if="pendingInvitations.length > 0">
                    ...
                    <ul class="space-y-2">
                        <li
                            ...
                            :key="inv.id"
                            class="flex flex-col gap-3 rounded-2xl border border-violet-100 bg-white px-4 py-3 shadow-sm sm:flex-row sm:items-center sm:gap-4"
                        >
                            ...
                            <!-- Actions -->
                            <div class="flex flex-shrink-0 items-center gap-2 sm:ml-auto">
                                <button
                                    @click="accept(inv.id)"
                                    class="inline-flex flex-1 sm:flex-none items-center justify-center gap-1.5 rounded-xl bg-violet-600 px-3 py-2 text-xs font-semibold text-white shadow-sm shadow-violet-200 transition hover:bg-violet-700"
                                >
                                    <Check class="h-3 w-3" />
                                    Accept
                                </button>
                                <button
                                    ...
                                    class="inline-flex flex-1 sm:flex-none items-center justify-center gap-1.5 rounded-xl border border-gray-200 px-3 py-2 text-xs font-medium text-gray-500 transition hover:border-gray-300 hover:text-gray-700"
                                >
                                    <X class="h-3 w-3" />
                                    Decline
                                </button>
